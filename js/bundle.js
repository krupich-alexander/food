...
function calc() {
    ...
    function setStaticInformation(selector, classActive){
        const elements = document.querySelectorAll(selector);
...
function forms(formSelector, modalTimerId) {
    ...
    function formThanks(message) {
        ...
        (0,_modal__WEBPACK_IMPORTED_MODULE_0__.modalShow)('.modal', modalTimerId);
...
function timer(id, deadline) {
    ...
    function getTimeRemaining(endtime){
        const t = Date.parse(endtime) - Date.parse(new Date()),
            ...
            houses = Math.floor((t / (1000 * 60 * 60)) % 24),
    ...
    function updateClock(){
        const t = getTimeRemaining(endtime);
            ...
            hours.innerHTML = getZero(t.houses);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.modalShow)('.modal', modalTimerId), 10000);
